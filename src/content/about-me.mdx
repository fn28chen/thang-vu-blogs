...
I'm also into technical writing and blogging. I write mostly on [Dev.to](https://dev.to/asheeshh). I'm also a freelance technical writer for [Scrimba](https://scrimba.com) and [Kinsta](https://kinsta.com).
