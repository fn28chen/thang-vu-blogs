...
export default function BlogCard({
  ...
  return (
    <Card
      key={ICardProps._id}
      className="flex flex-col  justify-between px-4 py-4 gap-4 border-zinc-400 border-4 duration-200 hover:shadow-lg hover:-translate-y-1 relative overflow-hidden lg:col-span-4"
    >
