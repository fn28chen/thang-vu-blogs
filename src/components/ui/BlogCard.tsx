...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 justify-between group">
        <div className="text-center group-hover:hidden transition duration-200 w-full mx-auto flex items-center justify-center">
          {icon}
        </div>
        <h2 className="dark:text-white text-xl hidden group-hover:block relative z-10 text-black mt-4 font-bold group-hover:text-white group-hover:-translate-y-2 transition duration-200">
          {title}
        </h2>
      </div>
    </div>
